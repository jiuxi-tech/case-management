...
def process_case_upload(request, app): 
    ...
    try: 
        ...
        required_headers.extend(["案件编码", "涉案人员编码", "立案时间", "立案决定书", "纪委立案时间", "纪委立案机关", "监委立案时间", "监委立案机关", "填报单位名称", "是否违反中央八项规定精神", "是否主动交代问题"])
        ...
        # 验证字段关系 - 接收所有18个返回值 (原来17个 + 新增的 1 个)
        mismatch_indices, gender_mismatch_indices, age_mismatch_indices, brief_case_details_mismatch_indices, issues_list, birth_date_mismatch_indices, education_mismatch_indices, ethnicity_mismatch_indices, party_member_mismatch_indices, party_joining_date_mismatch_indices, filing_time_mismatch_indices, disciplinary_committee_filing_time_mismatch_indices, disciplinary_committee_filing_authority_mismatch_indices, supervisory_committee_filing_time_mismatch_indices, supervisory_committee_filing_authority_mismatch_indices, case_report_keyword_mismatch_indices, disposal_spirit_mismatch_indices, voluntary_confession_highlight_indices = validate_case_relationships(df) 
        
        # 生成副本和立案编号文件 - 传递所有18个参数
        copy_path, case_num_path = generate_case_files( 
            ...
            case_report_keyword_mismatch_indices, # 新增的参数
            disposal_spirit_mismatch_indices, # 新增的参数
            voluntary_confession_highlight_indices # 新增的参数
        ) 
