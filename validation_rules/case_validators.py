...
def validate_case_relationships(df):
    ...
    for index, row in df.iterrows():
        ...
        # 调用新拆分的函数来处理这些特定验证
        highlight_recovery_amount(row, index, excel_case_code, excel_person_code, issues_list, recovery_amount_highlight_indices)
        validate_trial_acceptance_time_vs_report(row, index, excel_case_code, excel_person_code, issues_list, trial_acceptance_time_mismatch_indices)
        validate_trial_closing_time_vs_report(row, index, excel_case_code, excel_person_code, issues_list, trial_closing_time_mismatch_indices)
        validate_trial_authority_vs_reporting_agency(row, index, excel_case_code, excel_person_code, issues_list, trial_authority_agency_mismatch_indices, sl_authority_agency_mappings)
        validate_disposal_decision_keywords(row, index, excel_case_code, excel_person_code, issues_list, disposal_decision_keyword_mismatch_indices)
